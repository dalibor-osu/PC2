...
public class Test {
	...
	public static void main(String[] args) {
		...
		while (run) {
			...
			System.out.println("7 .. nacti databazi ze souboru");
			...
			switch (volba) {
				...
				case 6:
					ulozDoSouboru(mojeDatabaze, sc);
					break;

				case 7:
					nactiZeSouboru(mojeDatabaze, sc);
					break;
	...
	private static void ulozDoSouboru(Databaze databaze, Scanner sc)
	{
		System.out.println("Zadejte nazev souboru (nechte prazdne pro vychozi nazev \"databaze.txt\")");
		sc.nextLine();
		String soubor = sc.nextLine(); // Načtení názvu souboru, pokud je prázdný, použije se výchozí název
		if (soubor.equals("")) soubor = "databaze";
		System.out.println("Ukladam do souboru " + soubor);
		databaze.ulozDoSouboru(soubor);
	}

	private static void nactiZeSouboru(Databaze databaze, Scanner sc)
	{
		System.out.println("Zadejte nazev souboru, ze ktereho chcete databazi nacist (nechte prazdne pro vychozi nazev \"databaze.txt\")");
		sc.nextLine();
		String soubor = sc.nextLine(); // Načtení názvu souboru, pokud je prázdný, použije se výchozí název
		if (soubor.equals("")) soubor = "databaze";
